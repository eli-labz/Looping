...
- **Cobus Greyling** — [Looping](https://cobusgreyling.substack.com/p/looping) (June 2026)
  Companion essay for this repository: context engineering vs harness engineering vs Looping, the five primitives + memory, Grok mapping, and production realities.

- **Addy Osmani** — [Looping](https://addyosmani.com/blog/looping/) (June 2026)
...
- Various practitioners experimenting with closed-loop systems, feedback Looping, and "routines that prompt the model."
