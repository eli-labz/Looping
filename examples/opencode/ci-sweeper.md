...
Use [loop-cost](https://github.com/cobusgreyling/looping/blob/main/tools/loop-cost) before choosing a cadence; encode the daily cap in `LOOP.md` and `AGENTS.md` as a hard stop.
