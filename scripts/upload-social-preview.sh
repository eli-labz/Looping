...
SETTINGS_URL="https://github.com/cobusgreyling/looping/settings"

if [[ ! -f "${IMAGE}" ]]; then
  echo "Missing ${IMAGE}"
  echo "Regenerate with:"
  echo "  sips -c 640 1280 assets/visuals/looping-social-banner.jpg --out assets/visuals/social-preview.jpg"
  exit 1
fi
